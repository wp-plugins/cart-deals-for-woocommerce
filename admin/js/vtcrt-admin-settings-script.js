     jQuery(document).ready(function($) {
            ...
            //****************************  
                        ...
                        //**************  
                        $("#vtcrt-panel-5-help1-more").click(function(){
                            $("#vtcrt-panel-5-help1-text").show("slow"); 
                            $("#vtcrt-panel-5-help1-more").hide();
                            $("#vtcrt-panel-5-help1-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help1-less").click(function(){
                            $("#vtcrt-panel-5-help1-text").hide("slow");  
                            $("#vtcrt-panel-5-help1-less").hide();
                            $("#vtcrt-panel-5-help1-more").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help2-more").click(function(){
                            $("#vtcrt-panel-5-help2-text").show("slow"); 
                            $("#vtcrt-panel-5-help2-more").hide();
                            $("#vtcrt-panel-5-help2-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help2-less").click(function(){
                            $("#vtcrt-panel-5-help2-text").hide("slow");  
                            $("#vtcrt-panel-5-help2-less").hide();
                            $("#vtcrt-panel-5-help2-more").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help3-more").click(function(){
                            $("#vtcrt-panel-5-help3-text").show("slow"); 
                            $("#vtcrt-panel-5-help3-more").hide();
                            $("#vtcrt-panel-5-help3-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help3-less").click(function(){
                            $("#vtcrt-panel-5-help3-text").hide("slow");  
                            $("#vtcrt-panel-5-help3-less").hide();
                            $("#vtcrt-panel-5-help3-more").show("slow");                            
                        });                        
                        $("#vtcrt-panel-5-help4-more").click(function(){
                            $("#vtcrt-panel-5-help4-text").show("slow"); 
                            $("#vtcrt-panel-5-help4-more").hide();
                            $("#vtcrt-panel-5-help4-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help4-less").click(function(){
                            $("#vtcrt-panel-5-help4-text").hide("slow");  
                            $("#vtcrt-panel-5-help4-less").hide();
                            $("#vtcrt-panel-5-help4-more").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help5-more").click(function(){
                            $("#vtcrt-panel-5-help5-text").show("slow"); 
                            $("#vtcrt-panel-5-help5-more").hide();
                            $("#vtcrt-panel-5-help5-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help5-less").click(function(){
                            $("#vtcrt-panel-5-help5-text").hide("slow");  
                            $("#vtcrt-panel-5-help5-less").hide();
                            $("#vtcrt-panel-5-help5-more").show("slow");                            
                        });                        
                        $("#vtcrt-panel-5-help6-more").click(function(){
                            $("#vtcrt-panel-5-help6-text").show("slow"); 
                            $("#vtcrt-panel-5-help6-more").hide();
                            $("#vtcrt-panel-5-help6-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help6-less").click(function(){
                            $("#vtcrt-panel-5-help6-text").hide("slow");  
                            $("#vtcrt-panel-5-help6-less").hide();
                            $("#vtcrt-panel-5-help6-more").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help7-more").click(function(){
                            $("#vtcrt-panel-5-help7-text").show("slow"); 
                            $("#vtcrt-panel-5-help7-more").hide();
                            $("#vtcrt-panel-5-help7-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help7-less").click(function(){
                            $("#vtcrt-panel-5-help7-text").hide("slow");  
                            $("#vtcrt-panel-5-help7-less").hide();
                            $("#vtcrt-panel-5-help7-more").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help8-more").click(function(){
                            $("#vtcrt-panel-5-help8-text").show("slow"); 
                            $("#vtcrt-panel-5-help8-more").hide();
                            $("#vtcrt-panel-5-help8-less").show("slow");                            
                        });
                        $("#vtcrt-panel-5-help8-less").click(function(){
                            $("#vtcrt-panel-5-help8-text").hide("slow");  
                            $("#vtcrt-panel-5-help8-less").hide();
                            $("#vtcrt-panel-5-help8-more").show("slow");                            
                        });
