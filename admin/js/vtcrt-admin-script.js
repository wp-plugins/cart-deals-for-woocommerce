 ...
 */
                       ...
                       jQuery.noConflict();
                        ...
                        jQuery(document).ready(function($) {                                                        
                          ...
                          newHtml +=  '<div id="vtcrt-redirect">';
                          newHtml +=  '<a href="http://www.varktech.com/documentation/cart-deals/introrule"  target="_blank" id="vtcrt-redirect-anchor">';
                          newHtml +=  $("#vtcrt-docTitle").val();        //pick up the literals passed up in the html...  "Documentation"
                          newHtml +=  '</a></div>'; 
            ...
            //*************************************  
                     ...
                     //don't do this twice...           hideRemainderOfAllBoxes();
                            ...
                            function process_C_storeWideSale() { 
                              ...
                              enableAllDiscountLimits();
                              buyAmtType_repeat_reset3(); //mwntest  
                            };
                     ...
                     //         $("#action_group_box").show("slow");  
                            ...
                            function initAllValues() {      
                              ...
                              $(".vtcrt-error").hide("slow");  //hide all previous errors
                              $(".vtcrt-error2").hide("slow");  //hide all previous errors
                          ...
                          //    $("#priority_num").hide();   Handled elsewhere
                            ...
                            function buyAmtType_repeat_reset3() { 
                              $('.buy_repeat_condition_none').attr('disabled', true);
                              if ($("#templateChanged").val() == 'yes') {
                                $('.buy_repeat_condition_unlimited').attr('selected', true);
                              };
                              $('.buy_repeat_condition_unlimited').attr('disabled', false);
     ...
     //end old stuff
            ...
            //********************************************                                                                  
                        ...
                        function cartChoiceIn() {
                          ...
                          $("#vtcrt-pop-in-groups-cntl").hide(); 
                          $("#vtcrt-pop-in-groups-cntl-help").hide(); 
                          $("#buy_group_line_remainder").hide();   
                        };
                        function groupChoiceIn() {
                          $("#buy_group_line_remainder").show("slow"); //mwntest
                          $("#vtcrt-pop-in-groups-cntl").show("slow"); //mwntest
                          $("#vtcrt-pop-in-groups-cntl-help").show("slow");
                          $("#vtcrt-pop-in-cntl").show("slow");
                          $("#inPop-varProdID-cntl").hide("slow");
                          $("#singleChoiceIn-span").hide("slow");
                        ...
                        function varChoiceIn() {
                          $("#buy_group_line_remainder").show("slow"); //mwntest
                          $("#vtcrt-pop-in-groups-cntl").hide("slow"); //mwntest
                          $("#vtcrt-pop-in-groups-cntl-help").hide("slow");
                          $("#vtcrt-pop-in-cntl").hide("slow");
                        ...
                        function cartChoiceOut() {                            
                          $("#vtcrt-pop-out-cntl").hide("slow");
                          $("#vtcrt-pop-out-cntl-help").hide("slow");
                        ...
                        function groupChoiceOut() {
                          ...
                          $("#vtcrt-pop-out-cntl").show("slow");
                          $("#vtcrt-pop-out-cntl-help").show("slow");
                          $("#actionPop-varProdID-cntl").hide("slow");
                          $("#singleChoiceOut-span").hide("slow");
              ...
              //**************************************************************************************************                            
                        $("#ajaxVariationIn").click(function(){
                            ...
                            jQuery.ajax({
                               ...
                               data :  {action: "vtcrt_ajax_load_variations_in", inVarProdID: VarProdIDin } ,
                        ...
                        $("#ajaxVariationOut").click(function(){
                            ...
                            jQuery.ajax({
                               ...
                               data :  {action: "vtcrt_ajax_load_variations_out", outVarProdID: VarProdIDout } ,
                              success: function(response) {                                        
                        ...
                        //  Info Panel Toggles
                        //**************                         
                        $("#vtcrt-info1-help-all").click(function(){
                            $(".vtcrt-info1-help-text").toggle("slow");                         
                        });
                        $("#vtcrt-info1-help0").click(function(){
                            $("#vtcrt-info1-help0-text").toggle("slow");                           
                        });
                        $("#vtcrt-info1-help1").click(function(){
                            $("#vtcrt-info1-help1-text").toggle("slow");                           
                        }); 
                        $("#vtcrt-info1-help2").click(function(){
                            $("#vtcrt-info1-help2-text").toggle("slow");                           
                        }); 
                        $("#vtcrt-info1-help3").click(function(){
                            $("#vtcrt-info1-help3-text").toggle("slow");                           
                        }); 
                        $("#vtcrt-info1-help4").click(function(){
                            $("#vtcrt-info1-help4-text").toggle("slow");                           
                        }); 
                        $("#vtcrt-info1-help5").click(function(){
                            $("#vtcrt-info1-help5-text").toggle("slow");                           
                        });                       
                        $("#vtcrt-info1-help6").click(function(){
                            $("#vtcrt-info1-help6-text").toggle("slow");                           
                        });                       
                        
                                                
                        /*since there are 2 occurrences of each of these panels, must use Class!*/
                        $(".vtcrt-shortcode-details1-help").click(function(){
                            $(".vtcrt-shortcode-details1").toggle("slow");                           
                        });                                                          
                        $(".vtcrt-shortcode-details2-help").click(function(){
                            $(".vtcrt-shortcode-details2").toggle("slow");                           
                        });  
                        $(".vtcrt-shortcode-details3-help").click(function(){
                            $(".vtcrt-shortcode-details3").toggle("slow");                           
                        }); 
                         
                        $(".vtcrt-cartWidget-details1-help").click(function(){
                            $(".vtcrt-cartWidget-details1").toggle("slow");                           
                        });
                        ...
                        //**************  
                        $("#selection-panel-0 #vtcrt-panel-5-help1-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help1-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help1-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help1-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help1-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help1-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help1-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help1-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help2-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help2-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help2-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help2-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help2-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help2-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help2-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help2-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help3-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help3-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help3-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help3-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help3-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help3-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help3-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help3-more").show("slow");                            
                        });                        
                        $("#selection-panel-0 #vtcrt-panel-5-help4-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help4-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help4-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help4-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help4-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help4-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help4-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help4-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help5-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help5-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help5-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help5-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help5-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help5-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help5-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help5-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help6-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help6-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help6-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help6-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help6-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help6-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help6-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help6-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help7-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help7-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help7-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help7-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help7-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help7-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help7-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help7-more").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help8-more").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help8-text").show("slow"); 
                            $("#selection-panel-0 #vtcrt-panel-5-help8-more").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help8-less").show("slow");                            
                        });
                        $("#selection-panel-0 #vtcrt-panel-5-help8-less").click(function(){
                            $("#selection-panel-0 #vtcrt-panel-5-help8-text").hide("slow");  
                            $("#selection-panel-0 #vtcrt-panel-5-help8-less").hide();
                            $("#selection-panel-0 #vtcrt-panel-5-help8-more").show("slow");                            
                        });
                        ...
                        //**************  
                        $(".selection-panel-wrapper #vtcrt-panel-5-help1-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help1-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help1-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help1-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help1-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help1-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help1-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help1-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help2-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help2-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help2-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help2-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help2-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help2-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help2-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help2-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help3-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help3-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help3-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help3-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help3-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help3-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help3-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help3-more").show("slow");                            
                        });                        
                        $(".selection-panel-wrapper #vtcrt-panel-5-help4-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help4-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help4-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help4-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help4-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help4-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help4-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help4-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help5-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help5-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help5-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help5-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help5-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help5-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help5-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help5-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help6-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help6-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help6-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help6-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help6-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help6-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help6-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help6-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help7-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help7-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help7-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help7-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help7-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help7-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help7-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help7-more").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help8-more").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help8-text").show("slow"); 
                            $(".selection-panel-wrapper #vtcrt-panel-5-help8-more").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help8-less").show("slow");                            
                        });
                        $(".selection-panel-wrapper #vtcrt-panel-5-help8-less").click(function(){
                            $(".selection-panel-wrapper #vtcrt-panel-5-help8-text").hide("slow");  
                            $(".selection-panel-wrapper #vtcrt-panel-5-help8-less").hide();
                            $(".selection-panel-wrapper #vtcrt-panel-5-help8-more").show("slow");                            
                        });                        
