...
class VTCRT_Cart {	
    ...
    //used in function vtcrt_post_purchase_save_info, controls 2nd-nth iteration
...
class VTCRT_Cart_Item {
    ...
    $this->cartAuditTrail = array(
        /* **The following array structure is created on-the-fly during the apply process**
        // in $vtcrt_rule_test_info_framework *************
        array(
    ...
    $this->yousave_by_rule_info = array(  
       /* **The following array structure is created on-the-fly during the apply process**
        array(
           ...
           'rule_execution_type' =>  $vtcrt_rules_set[$i]->rule_execution_type, //used in email msg production!            
...
class VTCRT_Cart_Functions{
    ...
    public function vtcrt_destroy_cart() { 
        global $vtcrt_cart;
        unset($vtcrt_cart);
    }
    ...
    */
    public function vtcrt_cart_oldprice() { 
        global $vtcrt_cart;
        echo '$vtcrt_cart->$cart_oldprice';
    }
    ...
    /*
     ...
     where you want the amount to show
    */    
    public function vtcrt_cart_yousave() { 
        global $vtcrt_cart;
        echo '$vtcrt_cart->$cart_yousave';
    }
    ...
    /*
     ...
     where you want the amount to show
    */
    public function vtcrt_cart_unit_oldprice($product_id) { 
        global $vtcrt_cart;
        foreach($vtcrt_cart->vtcrt_cart_items as $key => $vtcrt_cart_item) {
           if ($vtcrt_cart_item->product_id == $product_id) {
              echo $vtcrt_cart->cart_unit_oldprice;
              break;
           }
        }
    }
    ...
    /*
     ...
     where you want the amount to show
    */    
    public function vtcrt_cart_total_oldprice($product_id) { 
        global $vtcrt_cart;
        foreach($vtcrt_cart->vtcrt_cart_items as $key => $vtcrt_cart_item) {
           if ($vtcrt_cart_item->product_id == $product_id) {
              echo $vtcrt_cart_item->cart_total_oldprice;
              break;
           }
        }
    }
    ...
    /*
     ...
     where you want the amount to show
    */    
    public function vtcrt_cart_total_yousave($product_id) { 
        global $vtcrt_cart;
        foreach($vtcrt_cart->vtcrt_cart_items as $key => $vtcrt_cart_item) {
           if ($vtcrt_cart_item->product_id == $product_id) {
              echo $vtcrt_cart->cart_total_yousave;
              break;
           }
        }
    }    
...
$vtcrt_cart_functions = new VTCRT_Cart_Functions;
